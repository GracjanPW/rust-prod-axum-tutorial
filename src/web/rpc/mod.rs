...
async fn _rpc_handler(
	...
	let result_json: Value = match rpc_method.as_str() {
		// -- Task RPC methods
		"create_task" => expec_rpc_fn!(create_task, ctx, mm, rpc_params),
		"list_tasks" => expec_rpc_fn!(list_tasks, ctx, mm),
		"update_task" => expec_rpc_fn!(update_task, ctx, mm, rpc_params),
		"delete_task" => expec_rpc_fn!(delete_task, ctx, mm, rpc_params),
