...
use super::{encrypt_into_b64u, EncryptionContent};
...
#[derive(Debug)]
pub struct Token {
    pub ident: String,     // Identifies (username for example).
    pub exp: String,       // Expiration date in Rfc3339.
    pub sign_b64u: String, // Singature, base64url encoded
}
...
impl Display for Token {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f,"{}.{}.{}",b64u_encode(&self.ident), b64u_encode(&self.exp), self.sign_b64u)
    }
}
